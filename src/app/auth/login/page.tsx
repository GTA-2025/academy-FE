...
const SignInPage = () => {
  ...
  const { useLogin, isLoggingIn, loginErrors, clearErrors } = userAuthStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await useLogin(loginPayload);
    if (success) {
      router.replace("/home"); // Or appropriate redirect after signup
    }
  };

  return (
    <div className=" w-full md:mx-auto lg:w-full flex min-h-screen bg-white dark:bg-[#0a0a0a] justify-center items-center py-12">
      <div className="flex max-w-[1300px] w-full items-center rounded-xl overflow-hidden">
        {/* Left Section: Form */}
        <div className="w-full sm:w-1/2 sm:mx-auto  lg:w-1/2 md:mx-auto p-8 md:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full  h-[55px]  text-xl font-semi-bold "
        ...
        <div className="hidden lg:flex h-[700px] w-1/2 items-center bg-blue-600 p-12 flex-col justify-between rounded-[1rem] relative overflow-hidden">
          ...
          <div className="relative w-[85%] h-[400px]  rounded-lg flex items-center justify-center text-white text-xl overflow-hidden">
