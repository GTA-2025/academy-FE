  ...
  return (
    <section className="lg:px-[2rem] xl:px-[5rem] font-latoRegular py-8 md:py-12 lg:py-[3rem] xl:py-[5rem] flex-col lg:flex-row gap-8 md:gap-12 lg:gap-[3rem] flex justify-between max-w-[1920px] mx-auto">
      ...
      <section className="w-full px-4 sm:px-5 md:px-6 lg:px-8 xl:w-[50%]">
        <div className="p-1 rounded-full text-[12px] sm:text-[14px] w-[180px] sm:w-[200px] dark:border-brand-gray border-slate-400 border">
          <p className="flex gap-2 sm:gap-3 items-center">
            <span className="font-lato-bold bg-brand-primary text-brand-white p-1 w-[50px] sm:w-[60px] text-center rounded-full">
              NEW
            </span>{" "}
            GTA updates v1.0
          </p>
        ...
        <div className="w-full flex">
          <div className="mt-6 sm:mt-8 md:mt-10 lg:mt-12 xl:mt-[3rem] font-bold dark:text-brand-white">
            ...
            <div className="flex sm:flex-row gap-4 mt-8 sm:mt-10 md:mt-12 lg:mt-10 max-w-[90%] lg:max-w-full">
              <Link
                href={"/auth/login"}
                className="flex w-full sm:w-[50%] text-brand-primary items-center justify-center gap-2 h-[50px] sm:h-[60px] md:h-[70px] border-brand-primary border-[0.1px] rounded-btn text-base sm:text-lg md:text-xl font-bold transition-all hover:bg-blue-50 dark:hover:bg-blue-900/20"
              >
                <span>LOGIN</span>
              </Link>
              <Link
                href={"/auth/sign-up"}
                className="flex w-full sm:w-[50%] h-[50px] sm:h-[60px] md:h-[70px] items-center justify-center gap-2 text-white bg-brand-primary rounded-btn text-base sm:text-lg md:text-xl font-bold transition-all hover:bg-blue-700"
              >
                <p>SIGN UP</p>
              </Link>
            </div>
